...
% change format of figures globally: vector / raster
\newcommand{\includegraphicscustom}[2][1.0]{\includegraphics[width=#1\linewidth,center]{#2.eps}}
\newcommand{\includegraphicscustomlegend}[2][0.7]{\includegraphics[width=#1\linewidth,center]{#2_legend.eps}}