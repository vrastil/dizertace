...
\DIFdelend \DIFaddbegin \subsection[Supernovae]{\DIFaddend Supernovae\DIFaddbegin \footnote{\label{ftn1}\DIFadd{Some parts of this section have already been published in \textcite{mastersthesis_vrastil}.}}\DIFaddend }
...
\DIFdelbegin %DIFDELCMD < \subsection{%%%
\DIFdelend \DIFaddbegin \subsection[Weak lensing]{\DIFaddend Weak lensing\DIFaddbegin \footnote{\DIFadd{Some parts of this section have already been published in \textcite{mastersthesis_vrastil}.}}\DIFaddend }
...
\DIFdelbegin %DIFDELCMD < \subsection{%%%
\DIFdelend \DIFaddbegin \subsection[Large-scale structure]{\DIFaddend Large-scale structure\DIFaddbegin \footnote{\DIFadd{Some parts of this section have already been published in \textcite{mastersthesis_vrastil}.}}\DIFaddend }
...
\DIFdelbegin %DIFDELCMD < \subsection{%%%
\DIFdelend \DIFaddbegin \subsection[Galaxy clusters]{\DIFaddend Galaxy clusters\DIFaddbegin \footnote{\DIFadd{Some parts of this section have already been published in \textcite{mastersthesis_vrastil}.}}\DIFaddend }
...
\DIFdelbegin %DIFDELCMD < \subsection{%%%
\DIFdelend \DIFaddbegin \subsection[Strong lensing]{\DIFaddend Strong lensing\DIFaddbegin \footnote{\label{ftn2}\DIFadd{Some parts of this section have already been published in \textcite{mastersthesis_vrastil}.}}\DIFaddend }
...
\DIFdelend \DIFaddbegin \section[$f(R)$-gravity]{\DIFaddend $f(R)$-gravity\DIFaddbegin \footnote{\DIFadd{Some parts of this section have already been published in \textcite{mastersthesis_vrastil}.}}\DIFaddend }
...
\end{itemize} 
\DIFdelbegin %DIFDELCMD < \section{%%%
\DIFdelend \DIFaddbegin \section[Chameleon Gravity]{\DIFaddend Chameleon Gravity\DIFaddbegin \footnote{\DIFadd{Some parts of this section have already been published in \textcite{mastersthesis_vrastil}.}}\DIFaddend }
\label{sec_cham}
...
\end{figure*} 
\DIFdelbegin %DIFDELCMD < \section{%%%
\DIFdelend \DIFaddbegin \section[Other theories]{\DIFaddend Other theories\DIFaddbegin \footnote{\DIFadd{Some parts of this section have already been published in \textcite{mastersthesis_vrastil}.}}\DIFaddend }
