...
\clearpage{}\chapter{Cosmological Surveys}
...
As WFIRST will be a~NIR mission it will require visible band photometry for~photo-z determination. LSST will be the~premier ground-based facility to~provide those data. As for~Euclid, the~baryon acoustic oscillation spectroscopic survey will be helpful for~calibrating photo-z determinations for~LSST. The~comparison of~shear determinations between WFIRST and~LSST measurements will be useful for~understanding shape measurement systematics with~both facilities.\clearpage{}
