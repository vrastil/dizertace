...
\begin{figure*}
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\caption{$z=\zfour$}
	\end{subfigure}
	\caption{Halo mass function (relative) for different approximation schemes at different redshifts.}
	\label{fig:diff_hmf_diff_z}
\end{figure*}