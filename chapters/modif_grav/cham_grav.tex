...
\label{sec:num_cham}
In this section we will show results of results of numerical solutions of chameleon profile. Our algorithm for finding solutions to \eqref{eq_cham_r} uses the shooting method \parencite{10.5555/42249} and is based on the original algorithm of \textcite{mastersthesis_vrastil}.

\subsubsection{Spherical objects in background}

\subsubsection{NFW Halo}
\todo{Galaxies, clusters}