...
We ran our simulations with~the~Planck \LCDM\ cosmology \parencite{planck_cosm}. We expect our results to~apply generically to~cosmologies that are not too far from this set of~parameter values. 
% \begin{table}[!b]
% \centering
% % \vspace{-10mm}
% \begin{tabular}{ l c l }
