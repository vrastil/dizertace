...
% }
% \begin{sloppypar}
% We want~to split the~operator \(e^{\Delta t\HH}\) (approximately) into steps that, individually, can be integrated exactly.
