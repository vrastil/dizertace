...
where $\bm k$ is a wavenumber with modulus $k$ and hat represents quantities in Fourier space. From TODO EQUATIONS we will obtain the following equations in Fourier space:
\eq{
