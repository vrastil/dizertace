...
\todo{
    Briefly describe 2d order + higher corrections

    spherical collapse

    Figure from 2LPT, etc. \cite{2004astro.ph.12025T}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{cosmo_evol/app_compare.png}
