...
is conserved in the Einstein frame \cite{Waterhouse:2006wv}.
...
where $\tilde{\Gamma}^\mu_{\alpha\beta}$ are the Christoffel symbols of the metric $g_\uv^{(i)}$. In the Einstein frame metric this gives \cite{Waterhouse:2006wv}
\eq{
...
\begin{figure}
	...
	\caption{The effective chameleon potential for a massive spherical object of density $\rho_{\mbox{\scriptsize{obj.}}}$ surrounded by the background with density $\rho_{\mbox{\scriptsize{amb.}}}$. From \cite{2015PhR...568....1J}.}
	\label{fig_eff_pot}
\end{figure}
